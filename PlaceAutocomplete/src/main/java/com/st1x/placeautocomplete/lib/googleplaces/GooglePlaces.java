package com.st1x.placeautocomplete.lib.googleplaces;

import android.util.Log;

import com.st1x.placeautocomplete.lib.googleplaces.models.DetailsResult;
import com.st1x.placeautocomplete.lib.googleplaces.models.PlacesPredictions;
import com.st1x.placeautocomplete.lib.googleplaces.models.PlacesResult;
import com.st1x.placeautocomplete.lib.googleplaces.query.DetailsQuery;
import com.st1x.placeautocomplete.lib.googleplaces.query.NearbySearchQuery;
import com.st1x.placeautocomplete.lib.googleplaces.query.Query;
import com.st1x.placeautocomplete.lib.googleplaces.query.TextSearchQuery;
...
public class GooglePlaces {
	...
	public PlacesResult getPlaces(String[] types, String keyword, int radius, double lat, double lon)
	...
	public PlacesResult getPlaces(String[] types, int radius, double lat, double lon)
	...
	public PlacesResult getPlaces(Query query)throws JSONException, IOException {
    ...
    public PlacesPredictions getPredictions(Query query) throws JSONException, IOException {
        JSONObject response = executeRequest(query.toString());
        PlacesPredictions result = new PlacesPredictions(response);
        return result;
    }
	...
	private JSONObject executeRequest(String query) 
        ...
        Log.d("PlacesAPI", "request executed = " + query);
